...
class PlayerListener extends BaseListener
{
    ...
    {
        if ($this->getPlugin()->playerProfileExists($event->getPlayer()->getName()) !== true) {
    ...
    public function onPlayerCommand(PlayerCommandPreprocessEvent $event)
    {
        ...
        if ($this->getPlugin()->isJailed($event->getPlayer()->getName()) !== false) {
    ...
    public function onPlayerInteract(PlayerInteractEvent $event)
    {
        if ($this->getPlugin()->isSelectionMode($event->getPlayer())) {
            $event->setCancelled(true);
            if (array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->c1_tmp) !== true && array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->c2_tmp) !== true && array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->pos_tmp) !== true) {
                $this->getPlugin()->pos_tmp[$event->getPlayer()->getName()] = new Position($event->getBlock()->x, $event->getBlock()->y + 1, $event->getBlock()->z, $event->getBlock()->getLevel());
                $event->getPlayer()->sendMessage($this->getPlugin()->colorMessage("&eNow tap on the 1st corner of the jail area."));
            } else if (array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->c1_tmp) !== true && array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->c2_tmp) !== true && array_key_exists($event->getPlayer()->getName(), $this->getPlugin()->pos_tmp) !== false) {
                $this->getPlugin()->c1_tmp[$event->getPlayer()->getName()] = new Position($event->getBlock()->x, $event->getBlock()->y, $event->getBlock()->z, $event->getBlock()->getLevel());
                ...
                unset($this->getPlugin()->c2_tmp[$event->getPlayer()->getName()]);
    ...
    public function onPlayerMove(PlayerMoveEvent $event)
    {
        $t = $this->getPlugin()->data->getAll();
        $j = $this->getPlugin()->data1->getAll();
        if ($this->getPlugin()->isJailed($event->getPlayer()->getName()) && $this->getPlugin()->jailExists($t[$event->getPlayer()->getName()]["jail"]) && $this->getPlugin()->insideJail($t[$event->getPlayer()->getName()]["jail"], $event->getPlayer()->getPosition()) !== true) {
            $event->getPlayer()->teleport(new Position($j[$t[$event->getPlayer()->getName()]["jail"]]["pos"]["x"], $j[$t[$event->getPlayer()->getName()]["jail"]]["pos"]["y"], $j[$t[$event->getPlayer()->getName()]["jail"]]["pos"]["z"], $this->getPlugin()->getServer()->getLevelByName($j[$t[$event->getPlayer()->getName()]["jail"]]["pos"]["level"])));
            $event->getPlayer()->sendPopup($this->getPlugin()->colorMessage("\n&2You are not allowed to leave the jail!"));
        }
        if ($this->getPlugin()->isJailed($event->getPlayer()->getName()) !== false && $this->getPlugin()->getConfig()->get("allow-movement") !== true) {
